<template>
  ...
  <div class="sub-header">
    ...
    Event recap for Jerrick's presentation at the LD Micro Invitational.
    </div>
  </div>
  <div class="news-grid">
    <div class="news-row" v-for="(news_item,index) in ld_micro_news" :key="news_item.position">
...
<script>
  ...
  export default {
    ...
    computed: mapGetters({
      ld_micro_news: 'ld-micro/get_all_ld_micro_news'
    }),
    methods: {
